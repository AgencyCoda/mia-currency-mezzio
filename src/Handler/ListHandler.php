 ...
 * 
 * @OA\Post(
 *     path="/mia_currency/list",
 *     summary="MiaCurrency List",
 *     tags={"MiaCurrency"},
 *     @OA\RequestBody(
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/MiaCurrency")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $rows = \Mia\Currency\Repository\MiaCurrencyRepository::fetchByConfigure($configure);
