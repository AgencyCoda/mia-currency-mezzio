...
namespace Mia\Currency\Repository;

use \Illuminate\Database\Capsule\Manager as DB;

/**
 * Description of MiaCurrencyRepository
 *
 * @author matiascamiletti
 */
class MiaCurrencyRepository 
{
    /**
     * 
    ...
    {
        $query = \Mia\Currency\Model\MiaCurrency::select('mia_currency.*');
